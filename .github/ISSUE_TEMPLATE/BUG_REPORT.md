---
name: RemoteArrays.jl bug report
about: Create a bug report to help us improve RemoteArrays.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("RemoteArrays")`:
```julia
julia> using Pkg; Pkg.status("RemoteArrays")
[YOUR OUTPUT HERE]
```
